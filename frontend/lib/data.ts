...
const REAL_ESA_PROGRAMS: Record<string, any[]> = {
  ...
  "AZ": [{"name": "Empowerment Scholarship Account — K-8", "status": "active; universal K-8 ESA", "portal_url": "https://www.azed.gov/esa", "application_url": "https://www.azed.gov/esa/eligibility-requirements", "platform": "ClassWallet", "max_award": "Varies by grade/weight; approximately $7,500 for K-8 students; funded quarterly", "eligibility": "Universal — all Arizona K-8 students eligible (expanded 2022). No income cap.", "deadline": "Rolling enrollment — apply anytime; ADE processes within 30 days", "deadlines": [{"type": "application_window", "due": "Rolling — open year-round", "description": "Apply anytime; ongoing enrollment"}], "documents_required": ["Proof of Arizona residency", "Student's birth certificate", "Withdrawal form from prior school (if applicable)", "Homeschool affidavit"], "forms": [], "notes": "ClassWallet is the financial management platform. ESA can support education at home but families sign ESA contract and spending rules apply. Quarterly expense reporting required.", "compliance_burden": "medium"}, {"name": "Empowerment Scholarship Account — 9-12", "status": "active; universal 9-12 ESA", "portal_url": "https://www.azed.gov/esa", "application_url": "https://www.azed.gov/esa/eligibility-requirements", "platform": "ClassWallet", "max_award": "Varies by grade/weight; approximately $8,500-$10,000 for high school students; funded quarterly", "eligibility": "Universal — all Arizona 9-12 students eligible. No income cap.", "deadline": "Rolling enrollment — apply anytime; ADE processes within 30 days", "deadlines": [{"type": "application_window", "due": "Rolling — open year-round", "description": "Apply anytime; ongoing enrollment"}], "documents_required": ["Proof of Arizona residency", "Student's birth certificate", "Withdrawal form from prior school (if applicable)", "Homeschool affidavit"], "forms": [], "notes": "Higher award amounts for high school students. Same ClassWallet platform and reporting requirements as K-8 ESA. Can be used for dual enrollment and college prep expenses.", "compliance_burden": "medium"}, {"name": "Empowerment Scholarship Account — Students with Disabilities", "status": "active; special-needs ESA", "portal_url": "https://www.azed.gov/esa", "application_url": "https://www.azed.gov/esa/eligibility-requirements", "platform": "ClassWallet", "max_award": "Enhanced rate; varies by disability category. Baseline ESA amount plus supplemental weighting.", "eligibility": "Arizona K-12 students with qualifying disabilities on an IEP or 504 plan. No income cap.", "deadline": "Rolling enrollment — apply anytime", "deadlines": [{"type": "application_window", "due": "Rolling — open year-round", "description": "Open enrollment for special needs students"}], "documents_required": ["IEP or 504 plan documentation", "Proof of Arizona residency", "Student's birth certificate", "Homeschool affidavit"], "forms": [], "notes": "Enhanced ESA for students with disabilities. Higher funding levels via disability weighting formula. Same ClassWallet platform and quarterly reporting requirements.", "compliance_burden": "medium"}],
  "FL": [{"name": "Personalized Education Program (PEP)", "status": "active; universal K-12 homeschool ESA", "portal_url": "https://www.stepupforstudents.org/scholarships/personalized-education-program/", "application_url": "https://www.stepupforstudents.org/scholarships/personalized-education-program/", "platform": "Step Up For Students EMA", "max_award": "$8,000 average per student; varies by grade and county", "eligibility": "Florida K-12 residents not enrolled full-time in public school. Universal — no income cap.", "deadline": "Open until program caps; PEP 2026-27 cap noted at 140,000 students", "deadlines": [{"type": "application_window", "due": "Open until cap reached", "description": "Rolling enrollment while funds last"}], "documents_required": ["Proof of Florida residency", "Student's birth certificate", "Withdrawal form from prior school (if applicable)"], "forms": [], "notes": "PEP is the ESA-style option for homeschool students. Funds can pay for curriculum, tutoring, therapies, and other qualified expenses. Managed by Step Up For Students.", "compliance_burden": "medium"}, {"name": "Family Empowerment Scholarship — Unique Abilities (FES-UA)", "status": "active; special-needs ESA", "portal_url": "https://www.stepupforstudents.org/scholarships/unique-abilities/", "application_url": "https://www.stepupforstudents.org/scholarships/unique-abilities/", "platform": "MyScholarShop / Step Up For Students", "max_award": "$10,000 average per student; varies by disability matrix and grade", "eligibility": "Florida K-12 students with an IEP or 504 plan", "deadline": "Open enrollment; rolling approvals", "deadlines": [{"type": "application_window", "due": "Rolling — open year-round", "description": "Open enrollment for special needs students"}], "documents_required": ["IEP or 504 plan documentation", "Proof of Florida residency", "Student's birth certificate"], "forms": [], "notes": "ESA-style scholarship for students with qualifying disabilities. Can be used for private school tuition, therapies, curriculum, and related services. Higher award values than PEP.", "compliance_burden": "medium"}, {"name": "Florida Tax Credit (FTC) Scholarship", "status": "active; income-based tax-credit scholarship", "portal_url": "https://www.stepupforstudents.org/scholarships/tax-credit/", "application_url": "https://www.stepupforstudents.org/scholarships/tax-credit/", "platform": "AAA Scholarship systems / Step Up For Students", "max_award": "$8,000 average per student; varies by grade", "eligibility": "Income-eligible Florida K-12 students (up to 300% FRL or near-poverty level)", "deadline": "Annual enrollment; priority deadlines per scholarship funding organization", "deadlines": [{"type": "application_window", "due": "Varies by SO (typically spring)", "description": "Enrollment windows vary by scholarship funding organization"}], "documents_required": ["Income verification", "Proof of Florida residency", "Student's birth certificate"], "forms": [], "notes": "Tax-credit funded scholarship for income-eligible families. Not homeschool-specific but can support homeschool costs if student is enrolled in participating private school part-time.", "compliance_burden": "medium"}],
